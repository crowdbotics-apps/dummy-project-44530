...
const Polygon = ({
  ...
  return <MapboxGL.ShapeSource id="line2" shape={centerdPolygon}>
      <MapboxGL.FillLayer id="fillCentered" style={toggleStyles.JEIUhryy} />
      <MapboxGL.LineLayer id="linelayer2" style={toggleStyles.MsuyVoqh} />
...
const Routes = ({
  ...
  return <>
      {Object.keys(firstRoute).length !== 0 && !isToggleOn && <MapboxGL.ShapeSource id="line1" shape={firstRoute}>
          <MapboxGL.LineLayer id="linelayer1" style={toggleStyles.hwVTeIGb} />
        </MapboxGL.ShapeSource>}
      {Object.keys(secondRoute).length !== 0 && isToggleOn && <MapboxGL.ShapeSource id="line3" shape={secondRoute}>
          <MapboxGL.LineLayer id="linelayer3" style={toggleStyles.yUfykRJj} />
        </MapboxGL.ShapeSource>}
    </>;
};