...
import { SignInTab, SignupTab } from "./screens/loginsignup.js";
import PasswordReset from "./screens/reset.js";
  ...
  return <NavigationHelpersContext.Provider value={navigation}>
      ...
      flex: 1
        ...
        <ScrollView style={[styles.container]}>
          <View style={_styles.FdijpbHK}>
            <View style={styles.imageContainer}>
              <ImageBackground source={{
              uri: BACKGROUND_URL
            }} style={_styles.FshQwjMq}>
                <Image source={{
                uri: LOGO_URL
              }} style={_styles.vHMPyFKL} />
              </ImageBackground>
            </View>
          </View>
