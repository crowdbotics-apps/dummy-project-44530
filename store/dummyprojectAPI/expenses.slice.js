...
export const api_v1_expense_list = createAsyncThunk("expenses/api_v1_expense_list", async payload => {
  const response = await apiService.api_v1_expense_list(payload);
  return response.data;
});
export const api_v1_expense_create = createAsyncThunk("expenses/api_v1_expense_create", async payload => {
  const response = await apiService.api_v1_expense_create(payload);
  return response.data;
});
export const api_v1_expense_retrieve = createAsyncThunk("expenses/api_v1_expense_retrieve", async payload => {
  const response = await apiService.api_v1_expense_retrieve(payload);
  return response.data;
});
export const api_v1_expense_update = createAsyncThunk("expenses/api_v1_expense_update", async payload => {
  const response = await apiService.api_v1_expense_update(payload);
  return response.data;
});
export const api_v1_expense_partial_update = createAsyncThunk("expenses/api_v1_expense_partial_update", async payload => {
  const response = await apiService.api_v1_expense_partial_update(payload);
  return response.data;
});
export const api_v1_expense_destroy = createAsyncThunk("expenses/api_v1_expense_destroy", async payload => {
...
const expensesSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_expense_list.pending, (state, action) => {
